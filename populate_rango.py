...
def populate():
    ...
    python_pages = [
        ...
        {'title':'How to Think like a Computer Scientist', 'url':'http://www.greenteapress.com/thinkpython/', "views": 37},
        {'title':'Learn Python in 10 Minutes', 'url':'http://www.korokithakis.net/tutorials/python/', "views": 22} ]

    django_pages = [
        {'title':'Official Django Tutorial', 'url':'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', "views": 7},
    ...
    other_pages = [
        ...
        {'title':'Flask', 'url':'http://flask.pocoo.org', "views": 78} ]
